...
/*
Service layers have an encryptPDFFile() method, which is in charge of creating a
directory for the uploaded file. Encrypt it and save to the specified directory. The Service
layer class also uses @Slfl4J for logging
 */
@Service
@Slf4j
public class UploadService {
    private final static String FILE_EXTENSION = ".pdf";
    public void encryptPDFFile(String path, String fileName, MultipartFile multipartFile,
