package com.GLAB309_8_2.studentlogin.repository;
...
It includes the full API of CrudRepository and PagingAndSortingRepository. It
contains basic CRUD operations, pagination and sorting.
    ...
    wrapper class of your @Id that is created inside the Entity/Model
    class.
 */
