package com.GLAB309_7_1.SpringCRUD.mycontroller;

import com.GLAB309_7_1.SpringCRUD.model.Tutorial;
import com.GLAB309_7_1.SpringCRUD.myservices.TutorialServices;
...
public class TutorialController {
    ...
    /* The TutorialRepository provides a method findById(). This method takes the id of
    the Tutorial to find. This method used to be findOne(). But since Spring data jpa 2.0
    it's changed to findById(). */
        return tutorialServices.getTutorialById(id);
    }

    /* To add new Tutorials is really easy. You do this by using the TutorialRepository
    save() method. */
    ...
    /* To delete a tutorials record, you simply use the deleteById() method provided by the
    tutorialRepository. Then you pass in the id of the record you want to delete.
    */
