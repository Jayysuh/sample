public class Task4 {
    public static void main(String[] args) {
        ...
        System.out.println("First index of intArray: " + intArray[0]);
        System.out.println("Last index of intArray: " + intArray[intArray.length - 1]);

        //throws ArrayIndexOutOfBoundsException
        System.out.println("Length index: " + intArray[intArray.length]);
        //throws ArrayIndexOutOfBoundsException
        System.out.println("intArray at index 5: " + intArray[5]);
    }
}
